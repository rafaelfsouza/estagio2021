...
Route::group(['namespace' => 'Admin', 'middleware' => 'redirectBack'], function() {
    ...
    Route::middleware(['admin.auth:admin', 'auth:admin'])->name('admin.')->group(function () {
        ...
        Route::namespace('Documentos')->group(function () {
            Route::get('download/{id}', 'DocumentoController@download')->name('download');
        });
    ...
    Route::middleware(['admin.auth:admin', 'auth:admin', 'permissoes'])->name('admin.')->group(function () {
        ...
        Route::middleware(['only_admin'])->group(function () {
            ...
            Route::namespace('Categorias')->group(function () {
