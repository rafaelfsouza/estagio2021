...
class UsuarioController extends Controller {
    ...
    public function create(){
        ...
        $perfis   = $this->perfilRepository->data(auth()->user()->cliente_id);
    ...
    public function destroy($id){
        ...
        $usuario = $this->usuarioRepository->delete($id, auth()->user()->cliente_id);
    ...
    public function AlterarSenha()
    {
        ...
        $usuario = $this->usuarioRepository->show(auth()->user()->id);
    ...
    public function SenhaUpdate(Senha $request)
    {
        ...
        $usuario = $this->usuarioRepository->updateSenha(auth()->user()->id, $input);
