        ...
        <div class="row justify-content-center mt-5">
            <div class="col-10">
                ...
                <div class="row no-gutters justify-content-end">
                   <a href="{{ route('admin.usuarios.edit', ['id' => $usuario->id]) }}" class="btn btn-outline-primary mr-2">Editar <i class="fas fa-pencil-alt"></i></a>
                    <button type="button" data-label="{{ $usuario->nome }}" data-url="{{ route('admin.usuarios.destroy', $usuario->id) }}" class="btn btn-outline-danger btn-delete">Excluir <i class="far fa-trash-alt"></i></button>
                </div>
                {{ Form::close() }}
            </div>
        </div>
