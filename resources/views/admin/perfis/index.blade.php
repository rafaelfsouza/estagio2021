                                    ...
                                    <td>
                                        <div class="row no-gutters justify-content-end">
                                            ...
                                            <a href="{{ route('admin.perfis.edit', ['id' => $row->id]) }}" class="btn btn-link btn-sm text-primary mr-1" data-toggle="tooltip" data-placement="left" title="Editar"><i class="fas fa-pencil-alt"></i></a>
                                                <button class="btn btn-link btn-sm text-danger btn-delete" data-label="{{ $row->perfil }}" data-url="{{ route('admin.perfis.destroy', $row->id) }}" data-toggle="tooltip" data-placement="left" title="Deletar"><i class="far fa-trash-alt"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
