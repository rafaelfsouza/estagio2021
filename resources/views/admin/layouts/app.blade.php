...
<div>
    ...
    <nav class="navbar justify-content-end text-right navbar-expand-lg navbar-dark bg-primary" id="menu-topo">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link {{ Route::currentRouteName() == 'admin.dashboard' ? 'active' : '' }}">{{ auth()->user()->cliente_id ? 'Documentos' : 'Home' }}</a>
                </li>
                <li class="nav-item admin-categorias">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="menu-usuarios">
                        <a href="{{ route('admin.usuarios.index') }}" class="dropdown-item admin-usuarios">Usuários</a>
                        <a href="{{ route('admin.perfis.index') }}" class="dropdown-item admin-perfis">Perfis de Acesso</a>
                    </div>
                </li>

                <li class="nav-item">
                    <a href="{{ route('admin.senha') }}" class="nav-link">Alterar Senha</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.logout') }}" class="nav-link" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Sair</a>
                </li>
            </ul>
        </div>
    </nav>
